...
public class Hanoi 
{
    ...
    {
	a = new PileHanoi("A", new AffichageGraphique("Pile A")) ;
	b = new PileHanoi("B", new AffichageGraphique("Pile B")) ;
	c = new PileHanoi("C", new AffichageGraphique("Pile C"));
	for (int i=n; i>0; i--)
    ...
    if(arg.length == 0){
        ...
        else if(arg.length == 1 && arg[0].equals("--auto")){
        System.out.println("depart");
        affiche();
        a.resoudreAuto(a,c,b);
